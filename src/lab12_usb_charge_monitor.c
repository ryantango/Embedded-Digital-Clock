/*
 * lab12_usb_charge_monitor.c
 *
 * ESE 123 - Embedded Digital Clock Project
 * ATmega4809 USB-C Power Monitoring Firmware
 *
 * This file is a cleaned, portfolio-ready version of the Lab 12 firmware
 * developed for the digital clock project. It demonstrates ADC-based current
 * sensing, USB-C CC1/CC2 connection detection, power calculation, and charge
 * energy accumulation.
 *
 * IMPORTANT:
 * This source depends on instructor-provided support functions declared in
 * "functions.h" (for example setup(), disp_float(), and measure_AVDD()).
 * That instructor-provided file is intentionally not included in the public
 * repository, so this source is provided for documentation/portfolio purposes
 * rather than as a standalone build.
 */
